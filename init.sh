...
sed -i "s|input_your_port|$LANPROXY_PORT|g" /lanproxy-client/distribution/proxy-client-0.1/conf/config.properties
sed -i "s|input_your_ssl|$LANPROXY_SSL|g" /lanproxy-client/distribution/proxy-client-0.1/conf/config.properties
